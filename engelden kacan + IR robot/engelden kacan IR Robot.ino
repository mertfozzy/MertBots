...
void sag(){ // Robotun sağa dönme hareketi için fonksiyon tanımlıyoruz.
  ...
  digitalWrite(SagMotor1, HIGH); // Sağ motorun ileri hareketi aktif
  digitalWrite(SagMotor2, LOW); // Sağ motorun geri hareketi pasif
  analogWrite(SagMotorEN, 0); // Sağ motorun hızı 0 (Motor duruyor)

  digitalWrite(SolMotor1, HIGH); // Sol motorun ileri hareketi aktif
  digitalWrite(SolMotor2, LOW); // Sol motorun geri hareketi pasif
  analogWrite(SolMotorEN , 150); // Sol motorun hızı 150
  
  
}
void geri(){ // Robotun geri yönde hareketi için fonksiyon tanımlıyoruz.

  digitalWrite(SagMotor1, LOW); // Sağ motorun ileri hareketi pasif
  digitalWrite(SagMotor2, HIGH); // Sağ motorun geri hareketi aktif
  analogWrite(SagMotorEN, 150); // Sağ motorun hızı 150

  digitalWrite(SolMotor1, LOW); // Sol motorun ileri hareketi pasif
  digitalWrite(SolMotor2, HIGH); // Sol motorun geri hareketi aktif
  analogWrite(SolMotorEN, 150); // Sol motorun hızı 150
